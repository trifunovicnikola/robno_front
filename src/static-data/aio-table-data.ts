...
export const aioTableData = [
  {
    ...
    Broj_fakture: 'Dejesus',
    Datum_fakture: 'Chang',
    sifra_dobavljaca: '899 Raleigh Place',
    Broj_stavki: 8057,
    Broj_artikla: 'Munjor',
    Iznos_bez_PDVa: '+32 (818) 580-3557',
    PDV_iznos: 'dejesus.chang@yourcompany.biz',
    Iznos_sa_PDVom:'32',
  ...
  },
  {
    ...
    Broj_fakture: 'Short',
    Datum_fakture: 'Lowe',
    sifra_dobavljaca: '548 Cypress Avenue',
    Broj_stavki: 5943,
    Broj_artikla: 'Temperanceville',
    Iznos_bez_PDVa: '+11 (977) 574-3636',
    PDV_iznos: 'short.lowe@yourcompany.ca',
    Iznos_sa_PDVom:'32',
  ...
  },
  {
    ...
    Broj_fakture: 'Antoinette',
    Datum_fakture: 'Carson',
    sifra_dobavljaca: '299 Roder Avenue',
    Broj_stavki: 7894,
    Broj_artikla: 'Crayne',
    Iznos_bez_PDVa: '+49 (969) 505-3323',
    PDV_iznos: 'antoinette.carson@yourcompany.net',
    Iznos_sa_PDVom:'32',
  ...
  },
  {
    ...
    Broj_fakture: 'Lynnette',
    Datum_fakture: 'Adkins',
    sifra_dobavljaca: '158 Cyrus Avenue',
    Broj_stavki: 4831,
    Broj_artikla: 'Coyote',
    Iznos_bez_PDVa: '+48 (836) 545-3237',
    PDV_iznos: 'lynnette.adkins@yourcompany.info',
    Iznos_sa_PDVom:'32',
    labels: [aioTableLabels[3]]
  },
  {
