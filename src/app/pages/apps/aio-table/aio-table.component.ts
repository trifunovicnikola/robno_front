...
import { ImportExportServisService } from 'src/app/import-export-servis.service';
...
export class AioTableComponent implements OnInit, AfterViewInit {
  ...
  constructor(private dialog: MatDialog, private importExportServis: ImportExportServisService) {
  }
  ...
  ngOnInit() {
    ...
    this.proizvodi = this.importExportServis.pomocni_Zkalk.setValue;
    this.customers=this.importExportServis.pomocni_Zkalk.setValue
